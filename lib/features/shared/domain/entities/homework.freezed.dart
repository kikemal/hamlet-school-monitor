...
mixin _$Homework {
 ...
 String get id; String get classId; String get subjectId; String get teacherId; String get title; String? get description; DateTime get dueDate;@JsonKey(name: 'attachment_url') String? get attachmentUrl;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,classId,subjectId,teacherId,title,description,dueDate,attachmentUrl,createdAt,updatedAt);

@override
String toString() {
  return 'Homework(id: $id, classId: $classId, subjectId: $subjectId, teacherId: $teacherId, title: $title, description: $description, dueDate: $dueDate, attachmentUrl: $attachmentUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String classId, String subjectId, String teacherId, String title, String? description, DateTime dueDate,@JsonKey(name: 'attachment_url') String? attachmentUrl,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of Homework
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? classId = null,Object? subjectId = null,Object? teacherId = null,Object? title = null,Object? description = freezed,Object? dueDate = null,Object? attachmentUrl = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
class _Homework implements Homework {
  const _Homework({required this.id, required this.classId, required this.subjectId, required this.teacherId, required this.title, this.description, required this.dueDate, @JsonKey(name: 'attachment_url') this.attachmentUrl, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt});
...
/// Create a copy of Homework
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? classId = null,Object? subjectId = null,Object? teacherId = null,Object? title = null,Object? description = freezed,Object? dueDate = null,Object? attachmentUrl = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
