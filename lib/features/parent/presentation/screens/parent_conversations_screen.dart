...
class ParentConversationsScreen extends ConsumerStatefulWidget {
  const ParentConversationsScreen({super.key});

  @override
  ConsumerState<ParentConversationsScreen> createState() => _ParentConversationsScreenState();
}

class _ParentConversationsScreenState extends ConsumerState<ParentConversationsScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: ref.read(parentRepositoryProvider).fetchConversationsWithDetails(parentId),
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildConversationTile(conversation, parentId);
            },
          );
        },
      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.h),
            Text(
              'Start a conversation with your child\'s teacher to begin messaging.',
